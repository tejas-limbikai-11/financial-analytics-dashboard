...
export function QuickRegistration({ onSuccess, onSwitchToLogin }: QuickRegistrationProps) {
    ...
    <Card className="w-full max-w-md mx-auto">
      <CardHeader className="text-center">
        ...
        <CardTitle className="text-2xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
          Join Financial Analytics
        </CardTitle>
        <CardDescription>Create your account and start tracking your finances in minutes</CardDescription>
      </CardHeader>
      <CardContent>
        ...
        <div className="mt-6 space-y-4">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            ...
            <ul className="text-xs text-blue-700 space-y-1">
              <li>✓ Personal financial dashboard</li>
